                ...
                <div class="col-md-22">
                    <div class="card card-primary" style="box-shadow: 0px 5px 5px 5px #c0c0c0">
                        ...
                        <div class="text-center">
                           <strong> CONSULTA ESTADO DE CUENTA</strong>  <!--<span id="message" style="color: green;"><?php echo $message; ?></span>-->
                        </div>
                       </div>
                        <div class="card-body">  
                        <form action="controlador_estadocuentas.php" method="POST" enctype="multipart/form-data" name="formbuscar">
                        <div class="row">
                                        <div class="col-md-3">
                                       ...
                                       <div class="col-md-3">
                                           <div class="form-group">
                                            ...
                                            <input type="number" name="nro_doc" class="form-control" oninput="validateInput(this, 12)">
                                            </div>
                                       </div>
                                       <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="periodo" id="periodo" class="form-control">
											    <option >Seleccione </option>
											    <?php
													$queryperiodo = $conexion -> query ("SELECT id_periodo_lectivo,nombre_periodo FROM periodolectivo order by id_periodo_lectivo desc");
													while ($valoresperiodo = mysqli_fetch_array($queryperiodo)) {
														echo '
                                   ...
                                   <?php if (isset($_SESSION['message'])): ?>
                                    ...
                                    <?php if (isset($_SESSION['estudiantes']) && count($_SESSION['estudiantes']) > 0): ?>            
                                            <!-- Mostrar tabla con resultados si existe información del estudiante -->
                                              <h2>Destalle de Estado de Cuenta(s)</h2>
