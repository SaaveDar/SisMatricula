...
--
-- Table structure for table `detallematriculas`
--

DROP TABLE IF EXISTS `detallematriculas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `detallematriculas` (
  `iddetallematricula` int NOT NULL AUTO_INCREMENT,
  `idestudiante` int NOT NULL,
  `id_hismatricula` int NOT NULL,
  `id_periodolectivo` int NOT NULL,
  `periodolectivo` varchar(45) DEFAULT NULL,
  `periodoacademico` varchar(45) DEFAULT NULL,
  `cursos` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`iddetallematricula`,`idestudiante`,`id_hismatricula`,`id_periodolectivo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `detallematriculas`
--

LOCK TABLES `detallematriculas` WRITE;
/*!40000 ALTER TABLE `detallematriculas` DISABLE KEYS */;
/*!40000 ALTER TABLE `detallematriculas` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `estadopago` (
  ...
  `id_estudiante_estado_pago` int DEFAULT NULL,
  `id_pago_estado_pago` int DEFAULT NULL,
  `descripcion_estado` varchar(15) COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`id_estado_pago`),
  KEY `id_estudiante_estado_pago` (`id_estudiante_estado_pago`),
  KEY `id_pago_estado_pago` (`id_pago_estado_pago`),
  CONSTRAINT `estadopago_ibfk_1` FOREIGN KEY (`id_estudiante_estado_pago`) REFERENCES `estudiante` (`id_estudiante`),
  CONSTRAINT `estadopago_ibfk_2` FOREIGN KEY (`id_pago_estado_pago`) REFERENCES `pago` (`id_pago`)
...
INSERT INTO `estudiante` VALUES (1,1,2,3,1,'2024-10-22 07:56:33'),(2,4,3,2,1,'2024-10-22 08:46:04'),(3,5,3,3,1,'2024-10-22 09:17:05'),(4,6,1,2,1,'2024-10-22 21:23:37'),(7,7,2,1,0,'2024-10-27 15:51:19'),(8,7,2,2,1,'2024-11-01 22:48:50');
...
INSERT INTO `historialmatriculas` VALUES (1,7,1,2,0,1,'I',202320,0),(2,20,3,1,1,2,'II',202410,1),(3,21,1,6,2,2,'III',202420,1),(5,7,1,5,2,1,'V',202420,0),(6,7,1,2,2,1,'II',202420,0);
...
CREATE TABLE `matricula` (
  ...
  `id_periodo_lectivo_matricula` int DEFAULT NULL,
  `id_periodo_academico_matricula` int DEFAULT NULL,
  `id_programa_matricula` int DEFAULT NULL,
  `id_plan_matricula` int DEFAULT NULL,
  `id_unidad_didactica_matricula` int DEFAULT NULL,
  `id_pago_matricula` int DEFAULT NULL,
  ...
  CONSTRAINT `matricula_ibfk_2` FOREIGN KEY (`id_periodo_lectivo_matricula`) REFERENCES `periodolectivo` (`id_periodo_lectivo`),
  CONSTRAINT `matricula_ibfk_3` FOREIGN KEY (`id_periodo_academico_matricula`) REFERENCES `periodoacademico` (`id_periodo_academico`),
  CONSTRAINT `matricula_ibfk_4` FOREIGN KEY (`id_programa_matricula`) REFERENCES `programaestudios` (`id_programa`),
  CONSTRAINT `matricula_ibfk_5` FOREIGN KEY (`id_plan_matricula`) REFERENCES `planestudios` (`id_plan`),
  CONSTRAINT `matricula_ibfk_6` FOREIGN KEY (`id_unidad_didactica_matricula`) REFERENCES `unidaddidactica` (`id_unidad`),
  CONSTRAINT `matricula_ibfk_7` FOREIGN KEY (`id_pago_matricula`) REFERENCES `pago` (`id_pago`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `periodolectivo` VALUES (1,'2024-I',202410,0),(2,'2024-II',202420,1),(3,'2025-I',202510,0),(4,'2025-II',202520,0),(6,'2026-I',202610,0),(7,'2026-II',202620,0),(8,'2027-I',202710,0);
...
INSERT INTO `planestudios` VALUES (1,1,'ICSI','PLAN DE ESTUDIOS DE SISTEMAS',2024,1),(2,1,'APSTI','PLAN DE ESTUDIOS DE ARQUITECTURA DE PLAT. Y STI',2024,0),(3,2,'ENFTEC','PLAN DE ESTUDIOS DE ENFERMERIA',2024,0),(4,1,'APSTI','PLAN DE ESTUDIOS DE ARQUITECTURA DE PLAT. Y STI',2020,0),(5,1,'APSTI','PLAN DE ESTUDIOS DE ARQUITECTURA DE PLAT. Y STI',2018,0),(6,2,'ENFTEC','PLAN DE ESTUDIOS DE ENFERMERIA',2018,1);
...
INSERT INTO `unidaddidactica` VALUES (1,'SISTEMAS OPERATIVOS','SISOPE',2,'1','I','Empleabilidad','I',4,16,90,106,6,1),(2,'SOPORTE TÉCNICO','SOTEC',2,'1','I','Empleabilidad','I',4,16,90,106,6,1),(3,'SEGURIDAD DE REDES','SEGRED',2,'1','I','Empleabilidad','II',5,16,120,136,8,1),(4,'LOGICA COMPUTACIONAL','LOGCOMPU',2,'1','II','Empleabilidad','III',7,16,190,206,12,1),(5,'DESARROLLO DE APLICACIONES','DAPP',2,'1','II','EMPLEABILIDAD','IV',4,16,90,106,6,1),(6,'METODO DE DESARROLLO','METDAPP',2,'1','III','EMPLEABILIDAD','V',4,16,90,106,6,1),(7,'VIRTUALIZACION DE APLICACIONES','VAPP',2,'1','III','EMPLEABILIDAD','VI',5,16,120,136,8,1),(8,'PRIMEROS AUXILIOS','PRIMAXU',3,'2','II','EMPLEABILIDAD','IV',6,16,150,166,10,1),(9,'REDES','RED',4,'1','I','EMPLEABILIDAD','I',4,16,90,106,6,1);
...
-- Dump completed on 2024-11-02 19:48:53
