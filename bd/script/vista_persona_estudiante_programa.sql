CREATE VIEW vista_persona_estudiante_programa AS
    ...
    FROM
        persona pe
        JOIN postulante po ON po.id_persona_postulante = pe.id_persona
        JOIN estudiante e ON po.id_postulante = e.id_postulante_estudiante
        JOIN programaestudios pes ON e.id_programa_estudios_estudiante = pes.id_programa