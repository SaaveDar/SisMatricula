                ...
                <div class="col-md-12">
                    <div class="card card-primary" style="box-shadow: 0px 5px 5px 5px #c0c0c0">
                        <div class="card-header">
                            ...
                            <strong>REGISTRAR PROGRAMA DE ESTUDIOS</strong> <span id="message" style="color: green;"><?php echo $message; ?></span>
						    </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
									<div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="abreviatura_programa" class="form-control" placeholder="Ejem: APTSI o ENFTEC o CONTEC" maxlength="7" required>
                                        </div>
                                    </div>

                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <label for="">NOMBRE DEL PROGRAMA DE ESTUDIOS</label>
                                            <input type="text" name="nombre_programa" class="form-control" placeholder="Nombre completo del PE" maxlength="50" required>
                                        </div>
                                    </div>
                                </div>
                                <hr>
