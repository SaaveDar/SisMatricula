                ...
                <div class="col-md-12">
                    <div class="card card-primary" style="box-shadow: 0px 5px 5px 5px #c0c0c0">
                        <div class="card-header">
                            ...
                            <strong>REGISTRAR PERIODO ACADÉMICO</strong> <span id="message" style="color: green;"><?php echo $message; ?></span>
							</div>
                        </div>
                        <div class="card-body">
                            <form action="controladorpa.php" method="post" enctype="multipart/form-data">
                                <div class="row">
								
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">Nombre Periodo Académico</label>
                                            <input type="text" name="periodo_academico" class="form-control" maxlength="3" placeholder="Ejem: II " required>
                                        </div>
                                    </div>
