...
$fecha_matricula = isset($_SESSION['fecha_matricula']) ? $_SESSION['fecha_matricula'] : "";
...
<nav class="navbar navbar-dark bg-dark  navbar-expand-md navbar-light bg-light fixed-top">
	...
	<main>
	<div class="row">
        <div class="container" style="margin-top: 100px; width: 120%">
                ...
                <div class="col-md-12">
                    <div class="card card-primary" style="box-shadow: 0px 5px 5px 5px #c0c0c0">
                        ...
                        <div class="text-center">
                           <strong> REPORTE MATRICULA</strong>  <!--<span id="message" style="color: green;"><?php echo $message; ?></span>-->
                           
                        </div>
                      
                        </div>
                        <div class="card-body">  
                        <form action="controlador_alumnosmatriculados.php" method="POST" enctype="multipart/form-data" name="formbuscar">
                                <div class="row">
                                   ...
                                   <div class="col-md-2">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">Periódo Lectivo</label>
                                            <select name="periodo" id="periodo" class="form-control" required>
											    <option >Seleccione </option>
											    <?php
													$queryperiodo = $conexion -> query ("SELECT id_periodo_lectivo,nombre_periodo, numero_periodo FROM periodolectivo order by id_periodo_lectivo desc");
													while ($valoresperiodo = mysqli_fetch_array($queryperiodo)) {
														echo '
													<option value="'.$valoresperiodo["id_periodo_lectivo"].'">'.$valoresperiodo["nombre_periodo"].'</option>';
													}	?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="hidden" name="fecha_matricula" id="fecha_matricula" class="form-control" placeholder="fecha" value="<?php echo $fecha_matricula; ?>" readonly>
                                                </div>
                                            </div>  
                                </div>          
                                              ...
                                              <h2>Detalle matricula</h2>
                                                <table class="table table-bordered">
                                                    ...
                                                    foreach ($_SESSION['estudiantes'] as $estudiante): ?>
                                                        <tr>
                                                            <td><?= $contador++; ?></td>
                                                            <td><?= $estudiante['ciclo_curso']; ?></td>
                                                            <td><?= $estudiante['abrev_curso']; ?></td>
                                                            <td><?= $estudiante['curso_nombre']; ?></td>
                                                            <td><?= $estudiante['creditos']; ?></td>
                                                            <td><?= $estudiante['horas_semanales']; ?></td>
